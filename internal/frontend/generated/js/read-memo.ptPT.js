...
MISSING_MEMO_ID: 'Solicitação inválida. Por favor, verifique sua entrada e tente novamente.',
MISSING_PASSWORD: 'Por favor, introduza a palavra-passe de criptografia',
INVALID_MEMO_URL: 'URL do memo inválida',
MISSING_SECURITY_CHALLENGE: 'Por favor, complete o desafio de segurança',
MEMO_ALREADY_READ_DELETED: 'Este memo já foi lido e excluído, ou expirou.',
MEMO_EXPIRED_DELETED: 'Este memo expirou e foi excluído.',
INVALID_PASSWORD_CHECK: 'Palavra-passe inválida. Por favor, verifique a palavra-passe que recebeu separadamente.',
READ_MEMO_ERROR: 'Ocorreu um erro ao ler o memo',
DECRYPTION_ERROR: 'Falha ao descriptografar mensagem. Palavra-passe inválida ou dados corrompidos.'
};
...
decryptButton.textContent = 'Descriptografando...';
}
...
showError('Muitas solicitações. Por favor, aguarde um momento e tente novamente.');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'Memo descriptografado. Excluindo... Aguarde.';
}
if (deletionSpinner) {
...
showMessage('Muitas solicitações. Por favor, aguarde um momento e tente novamente.', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'Memo confirmado como lido e excluído permanentemente.';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('Erro ao confirmar exclusão. O memo será limpo automaticamente.', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'Descriptografar Memo';
}
if (decryptLoadingIndicator) {
