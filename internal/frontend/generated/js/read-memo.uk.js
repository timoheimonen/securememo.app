...
MISSING_MEMO_ID: 'Неправильний запит. Перевірте введені дані і спробуйте ще раз.',
MISSING_PASSWORD: 'Введіть пароль для шифрування',
INVALID_MEMO_URL: 'Неправильний URL записки',
MISSING_SECURITY_CHALLENGE: 'Будь ласка, виконайте перевірку безпеки',
MEMO_ALREADY_READ_DELETED: 'Ця записка вже була прочитана і видалена, або її термін закінчився.',
MEMO_EXPIRED_DELETED: 'Термін дії цієї записки закінчився і вона була видалена.',
INVALID_PASSWORD_CHECK: 'Неправильний пароль. Перевірте пароль, який ви отримали окремо.',
READ_MEMO_ERROR: 'Виникла помилка під час читання записки',
DECRYPTION_ERROR: 'Не вдалося розшифрувати повідомлення. Неправильний пароль або пошкоджені дані.'
};
...
decryptButton.textContent = 'Розшифрування...';
}
...
showError('Занадто багато запитів. Зачекайте і спробуйте ще раз.');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'Записку розшифровано. Видалення триває... Будь ласка, зачекайте.';
}
if (deletionSpinner) {
...
showMessage('Занадто багато запитів. Зачекайте і спробуйте ще раз.', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'Записку підтверджено як прочитану та остаточно видалено.';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('Помилка підтвердження видалення. Записка буде очищена автоматично.', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'Розшифрувати записку';
}
if (decryptLoadingIndicator) {
