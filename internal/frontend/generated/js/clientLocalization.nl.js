...
const TRANSLATIONS = {
  "nl": {
    ...
    "tos.acceptableUse.bypass": "Pogingen te doen om beveiligingsmaatregelen of rate limiting-bescherming te omzeilen",
    ...
    "tos.intellectualProperty.copyright": "Auteursrecht & DMCA-beleid: Als u denkt dat uw auteursrecht is geschonden, neem dan contact op via  met de vereiste informatie volgens de DMCA (bijv. identificatie van het werk, uw contactgegevens en een verklaring van goede trouw).",
    ...
    "privacy.informationCollected.securityChallenge": "Wij gebruiken rate limiting om geautomatiseerd misbruik te voorkomen. rate limiting is ontworpen met privacybescherming en volgt gebruikers niet over verschillende sites.",
    ...
    "privacy.howWeUse.security": "Beveiliging te waarborgen: Misbruik zoals spam of denial-of-service aanvallen detecteren en voorkomen met behulp van IP-logs en rate limiting.",
    ...
    "privacy.dataSecurity.securityMeasures": "Beveiligingsmaatregelen: Wij implementeren sterke beveiligingsheaders (zoals CSP, HSTS), input-sanitatie, bescherming tegen timing-aanvallen en rate limiting om misbruik te voorkomen.",
