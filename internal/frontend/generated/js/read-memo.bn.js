...
MISSING_MEMO_ID: 'অবৈধ অনুরোধ। অনুগ্রহ করে ইনপুট পরীক্ষা করে আবার চেষ্টা করুন।',
MISSING_PASSWORD: 'অনুগ্রহ করে এনক্রিপশন পাসওয়ার্ড লিখুন',
INVALID_MEMO_URL: 'অবৈধ মেমো URL',
MISSING_SECURITY_CHALLENGE: 'অনুগ্রহ করে নিরাপত্তা চ্যালেঞ্জ সম্পূর্ণ করুন',
MEMO_ALREADY_READ_DELETED: 'এই মেমোটি ইতোমধ্যে পড়া ও মুছে ফেলা হয়েছে, অথবা মেয়াদোত্তীর্ণ।',
MEMO_EXPIRED_DELETED: 'এই মেমোটি মেয়াদোত্তীর্ণ হয়েছে এবং মুছে ফেলা হয়েছে।',
INVALID_PASSWORD_CHECK: 'অবৈধ পাসওয়ার্ড। আলাদাভাবে পাওয়া পাসওয়ার্ডটি যাচাই করুন।',
READ_MEMO_ERROR: 'মেমো পড়ার সময় একটি ত্রুটি ঘটেছে',
DECRYPTION_ERROR: 'মেসেজ ডিক্রিপ্ট করতে ব্যর্থ। পাসওয়ার্ড অবৈধ বা ডেটা ক্ষতিগ্রস্ত।'
};
...
decryptButton.textContent = 'ডিক্রিপ্ট করা হচ্ছে...';
}
...
showError('অতিরিক্ত অনুরোধ। অনুগ্রহ করে কিছুক্ষণ অপেক্ষা করে আবার চেষ্টা করুন।');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'মেমো ডিক্রিপ্ট হয়েছে। মুছে ফেলা হচ্ছে... অনুগ্রহ করে অপেক্ষা করুন।';
}
if (deletionSpinner) {
...
showMessage('অতিরিক্ত অনুরোধ। অনুগ্রহ করে কিছুক্ষণ অপেক্ষা করে আবার চেষ্টা করুন।', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'মেমো পড়া হয়েছে এবং স্থায়ীভাবে মুছে ফেলা হয়েছে।';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('মুছে ফেলা নিশ্চিত করতে ত্রুটি। মেমো স্বয়ংক্রিয়ভাবে পরিষ্কার হয়ে যাবে।', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'মেমো ডিক্রিপ্ট করুন';
}
if (decryptLoadingIndicator) {
...
toggleBtn.textContent = 'লুকান';
toggleBtn.style.backgroundColor = '#007bff';
} else {
passwordInput.type = 'password';
toggleBtn.textContent = 'দেখান';
toggleBtn.style.backgroundColor = '#007bff';
}
});
}
