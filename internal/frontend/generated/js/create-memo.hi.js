...
if (!message) {
showMessage('कृपया एक मेमो दर्ज करें', 'error');
return;
}
if (message.length > 10000) {
showMessage('मेमो बहुत लंबा है (अधिकतम 10,000 अक्षर)', 'error');
return;
}
...
if (err) {
showMessage('कृपया सुरक्षा चुनौती पूरी करें', 'error');
...
submitButton.textContent = 'एन्क्रिप्ट कर रहे हैं...';
...
showMessage(result.error || 'मेमो बनाने में विफल', 'error');
}
}
} catch (error) {
showMessage('मेमो बनाते समय एक त्रुटि आई', 'error');
} finally {
submitButton.disabled = false;
submitButton.textContent = 'सुरक्षित मेमो बनाएं';
...
showMessage('✅ URL क्लिपबोर्ड में कॉपी हो गया!', 'success');
...
showMessage('⚠️ कृपया मैन्युअल रूप से कॉपी करें (Ctrl+C / Cmd+C)', 'warning');
}
});
...
showMessage('✅ पासवर्ड क्लिपबोर्ड में कॉपी हो गया!', 'success');
