...
MISSING_MEMO_ID: 'Ungültige Anfrage. Bitte überprüfen Sie Ihre Eingabe und versuchen Sie es erneut.',
MISSING_PASSWORD: 'Bitte geben Sie das Verschlüsselungspasswort ein',
INVALID_MEMO_URL: 'Ungültige Notiz-URL',
MISSING_SECURITY_CHALLENGE: 'Bitte vervollständigen Sie die Sicherheitsüberprüfung',
MEMO_ALREADY_READ_DELETED: 'Diese Notiz wurde bereits gelesen und gelöscht oder ist abgelaufen.',
MEMO_EXPIRED_DELETED: 'Diese Notiz ist abgelaufen und wurde gelöscht.',
INVALID_PASSWORD_CHECK: 'Ungültiges Passwort. Bitte überprüfen Sie das separat erhaltene Passwort.',
READ_MEMO_ERROR: 'Ein Fehler ist beim Lesen der Notiz aufgetreten',
DECRYPTION_ERROR: 'Entschlüsselung der Nachricht fehlgeschlagen. Ungültiges Passwort oder beschädigte Daten.'
};
...
decryptButton.textContent = 'Entschlüsseln...';
}
...
if (memoStatus) {
memoStatus.textContent = 'Notiz entschlüsselt. Löschung läuft... Bitte warten.';
}
if (deletionSpinner) {
...
showMessage('Zu viele Anfragen. Bitte warten Sie einen Moment und versuchen Sie es erneut.', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'Notiz als gelesen bestätigt und dauerhaft gelöscht.';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('Fehler beim Bestätigen der Löschung. Die Notiz wird automatisch bereinigt.', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'Notiz entschlüsseln';
}
if (decryptLoadingIndicator) {
