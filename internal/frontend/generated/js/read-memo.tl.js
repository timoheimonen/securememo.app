...
MISSING_MEMO_ID: 'Di-wastong kahilingan. Paki-suri ang iyong inilagay at subukang muli.',
MISSING_PASSWORD: 'Pakilagay ang password ng pag-encrypt',
INVALID_MEMO_URL: 'Di-wastong memo URL',
MISSING_SECURITY_CHALLENGE: 'Pakikumpleto ang security challenge',
MEMO_ALREADY_READ_DELETED: 'Nabasa at nabura na ang memo na ito, o nag-expire na.',
MEMO_EXPIRED_DELETED: 'Nag-expire na ang memo na ito at nabura na.',
INVALID_PASSWORD_CHECK: 'Di-wastong password. Pakisuri ang password na natanggap mo nang hiwalay.',
READ_MEMO_ERROR: 'May naganap na error habang binabasa ang memo',
DECRYPTION_ERROR: 'Nabigong i-decrypt ang mensahe. Di-wastong password o sirang datos.'
};
...
decryptButton.textContent = 'Dini-decrypt...';
}
...
showError('Sobra ang dami ng mga kahilingan. Maghintay sandali at subukang muli.');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'Na-decrypt ang memo. Binubura na... Mangyaring maghintay.';
}
if (deletionSpinner) {
...
showMessage('Sobra ang dami ng mga kahilingan. Maghintay sandali at subukang muli.', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'Kumpirmadong nabasa ang memo at permanenteng nabura.';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('Error sa pag-kumpirma ng pagbura. Awtomatikong lilinisin ang memo.', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'I-decrypt ang Memo';
}
if (decryptLoadingIndicator) {
...
toggleBtn.textContent = 'Itago';
toggleBtn.style.backgroundColor = '#007bff';
} else {
passwordInput.type = 'password';
toggleBtn.textContent = 'Ipakita';
toggleBtn.style.backgroundColor = '#007bff';
}
});
}
