...
const TRANSLATIONS = {
  "es": {
    ...
    "home.hero.subtitle": "Crea memos cifrados que se eliminan tras una confirmación de lectura correcta o al expirar. Tus secretos se mantienen seguros.",
    ...
    "home.features.destruct.description": "El memo se elimina automáticamente y de forma permanente después de leerse o cuando expira el límite de tiempo (de 8 horas a 30 días).",
    ...
    "privacy.dataSecurity.deletion": "Eliminación: Los memos se eliminan permanentemente después de leer o expirar mediante trabajos cleanup automatizados.",
