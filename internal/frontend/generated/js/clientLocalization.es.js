...
const TRANSLATIONS = {
  "es": {
    ...
    "privacy.internationalTransfers.content": "securememo.app está autoalojado en Finlandia. Los datos se procesan en Finlandia y mantenemos la recopilación al mínimo.",
    ...
    "faq.technology.answer": "securememo.app está construido en Go service para computación sin servidor, Base de Datos SQLite para almacenamiento, Web Crypto API para cifrado del lado del cliente, y HTML/CSS/JavaScript moderno. El código fuente es de código abierto y está disponible en GitHub.",
