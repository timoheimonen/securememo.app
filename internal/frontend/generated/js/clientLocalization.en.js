...
const TRANSLATIONS = {
  "en": {
    ...
    "home.current.hero.title": "Share secrets that disappear.",
    "home.current.hero.subtitle": "Create an encrypted memo in your browser. It deletes itself after it’s read or when it expires.",
    ...
    "home.current.delete.title": "It deletes itself",
    "home.current.delete.description": "The memo is removed after it’s read, or automatically when the expiry time runs out.",
    "home.current.schema.description": "Create an encrypted memo in your browser. It deletes itself after it’s read or when it expires. No tracking, no ads.",
    "schema.app.features.browserSideEncryption": "Browser-side encryption",
    "schema.app.features.selfDeletingMemos": "Self-deleting memos",
    "schema.app.features.noTrackingAds": "No tracking or ads",
    "about.current.hero.subtitle": "securememo.app lets you send short, private notes that vanish after reading. Everything is encrypted in your browser, so the server never sees what you wrote.",
    ...
    "about.current.delete.title": "Memos delete themselves",
    "about.current.delete.description": "A memo is removed after it's read, or when its expiry time runs out. Choose from 8 hours up to 30 days.",
    ...
    "about.current.ogDescription": "Discover how securememo.app protects memo content with browser-side encryption and automatic deletion after it's read or when it expires.",
