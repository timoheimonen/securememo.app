...
const TRANSLATIONS = {
  "ro": {
    ...
    "tos.acceptableUse.bypass": "Să încerci să ocolești măsurile de securitate sau protecția rate limiting",
    ...
    "tos.intellectualProperty.copyright": "Drepturi de autor și politica DMCA: Dacă consideri că drepturile tale de autor au fost încălcate, te rugăm să ne contactezi la  cu informațiile necesare conform DMCA (de exemplu, identificarea operei, datele tale de contact și o declarație de bună-credință).",
    ...
    "tos.contact.email": "sau trimite un e-mail la.",
    ...
    "privacy.informationCollected.memoData": "Date despre memo: Când creezi un memo, stocăm doar versiunea criptată a mesajului tău pe serverele noastre (folosind Go service și baza de date SQLite). Cheia de criptare (parola) este generată și gestionată în întregime în browserul tău și nu este niciodată trimisă sau stocată de noi. Memo-urile sunt șterse automat după ce sunt citite sau când expiră (opțiuni: 8 ore, 1 zi, 2 zile, 1 săptămână sau 30 de zile).",
    ...
    "privacy.informationCollected.securityChallenge": "Folosim rate limiting pentru a preveni abuzul automatizat. rate limiting este conceput să protejeze confidențialitatea și nu urmărește utilizatorii între site-uri.",
    ...
    "privacy.howWeUse.security": "Menținerea securității: Detectarea și prevenirea abuzurilor, precum spamul sau atacurile de tip denial-of-service, folosind jurnalele IP și rate limiting.",
    ...
    "privacy.dataSecurity.securityMeasures": "Măsuri de securitate: Implementăm antete de securitate puternice (de ex., CSP, HSTS), sanitizarea inputului, protecții împotriva atacurilor de temporizare și rate limiting pentru a preveni abuzurile.",
    ...
    "privacy.contact.email": "sau trimite un e-mail la.",
