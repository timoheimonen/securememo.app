...
const LOCAL_TRANSLATIONS = {
  "ro": {
    ...
    "btn.copyRevokeLink": "Copiază linkul de revocare",
    "btn.deleteMemo": "Șterge memo-ul",
    "btn.deleting": "Se șterge...",
    ...
    "page.revoke.title": "Revocă memo securizat - șterge un memo necitit",
    "page.revoke.description": "Folosește un link privat de revocare pentru a șterge un memo securizat criptat înainte să fie citit.",
    "page.revoke.keywords": "revocă memo securizat, șterge memo criptat, ștergere sigură notă, link privat de revocare memo",
    "page.revoke.ogDescription": "Șterge un memo securizat criptat înainte să fie citit folosind linkul tău privat de revocare.",
    "page.revoke.twitterDescription": "Șterge un memo securizat criptat înainte să fie citit.",
    ...
    "msg.revokeLinkCopied": "Linkul de revocare a fost copiat în clipboard!",
    ...
    "create.result.revokeLabel": "Link de revocare (păstrează-l privat):",
    "create.result.revokeHelp": "Folosește acest link privat pentru a șterge memo-ul înainte să fie citit. Este afișat o singură dată și nu poate fi recuperat după ce părăsești pagina.",
    "create.result.revokeWarning": "Păstrează linkul de revocare privat; oricine îl are poate șterge acest memo înainte să fie citit",
    ...
    "revoke.hero.title": "Revocă memo securizat",
    "revoke.hero.description": "Acest link privat de revocare poate șterge memo-ul înainte să fie citit. Ștergerea este permanentă și nu poate fi anulată.",
    "revoke.confirm.title": "Ștergi acest memo?",
    "revoke.confirm.before": "Înainte de a continua:",
    "revoke.confirm.exists": "Aceasta șterge imediat memo-ul dacă nu a fost deja citit, expirat sau șters",
    "revoke.confirm.permanent": "Ștergerea este permanentă și memo-ul nu poate fi recuperat",
    "revoke.confirm.recipient": "Destinatarul nu va mai putea citi memo-ul",
    "revoke.confirm.sends": "Această cerere trimite serverului doar ID-ul memo-ului și tokenul de revocare. Nu trimite parola memo-ului sau conținutul în text clar.",
    "revoke.status.deleting": "Se șterge memo-ul...",
    "revoke.success.title": "Memo șters",
    "revoke.success.description": "Memo-ul a fost revocat cu succes. Destinatarul nu îl mai poate citi.",
    "revoke.error.title": "Link de revocare invalid",
    ...
    "error.invalidRevokeLink": "Acest link de revocare este invalid sau incomplet.",
    "error.revokeNotFound": "Memo-ul nu a fost găsit, a fost deja șters, a expirat sau linkul de revocare este invalid.",
    "error.revokeFailed": "Memo-ul nu a putut fi revocat. Verifică conexiunea și încearcă din nou.",
    ...
    "about.current.storage.stored.revokeHash": "Hash-ul tokenului de revocare al expeditorului",
    ...
    "about.current.storage.notStored.rawTokens": "Tokenuri brute de ștergere sau revocare",
