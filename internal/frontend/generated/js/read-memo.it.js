...
MISSING_MEMO_ID: 'Richiesta non valida. Controlla il tuo input e riprova.',
MISSING_PASSWORD: 'Inserisci la password di crittografia',
INVALID_MEMO_URL: 'URL memo non valido',
MISSING_SECURITY_CHALLENGE: 'Completa la verifica di sicurezza',
MEMO_ALREADY_READ_DELETED: 'Questa memo è già stata letta ed eliminata, o è scaduta.',
MEMO_EXPIRED_DELETED: 'Questa memo è scaduta ed è stata eliminata.',
INVALID_PASSWORD_CHECK: 'Password non valida. Controlla la password ricevuta separatamente.',
READ_MEMO_ERROR: 'Si è verificato un errore durante la lettura della memo',
DECRYPTION_ERROR: 'Decrittazione fallita. Password non valida o dati corrotti.'
};
...
decryptButton.textContent = 'Decrittografia...';
}
...
showError('Troppe richieste. Attendere un momento e riprovare.');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'Memo decrittografata. Eliminazione in corso... Attendere.';
}
if (deletionSpinner) {
...
showMessage('Troppe richieste. Attendere un momento e riprovare.', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'Memo confermata come letta e eliminata definitivamente.';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('Errore nella conferma dell\'eliminazione. La memo verrà pulita automaticamente.', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'Decrittografa Memo';
}
if (decryptLoadingIndicator) {
