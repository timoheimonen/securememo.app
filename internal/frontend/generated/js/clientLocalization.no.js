...
const TRANSLATIONS = {
  "no": {
    ...
    "tos.acceptableUse.bypass": "Forsøke å omgå sikkerhetstiltak eller rate limiting-beskyttelse",
    ...
    "tos.intellectualProperty.copyright": "Opphavsrett og DMCA-policy: Hvis du mener at din opphavsrett er krenket, vennligst kontakt oss på  med nødvendig informasjon i henhold til DMCA (f.eks. identifikasjon av verket, dine kontaktopplysninger og en erklæring om god tro).",
    ...
    "tos.contact.email": "eller send e-post til.",
    ...
    "privacy.informationCollected.memoData": "Notatdata: Når du oppretter et notat, lagrer vi kun den krypterte versjonen av meldingen på våre servere (ved bruk av Go service og SQLite database). Krypteringsnøkkelen (passordet) genereres og håndteres kun i nettleseren din og sendes aldri til eller lagres av oss. Notater slettes automatisk etter at de er lest eller utløpt (alternativer: 8 timer, 1 dag, 2 dager, 1 uke eller 30 dager).",
    ...
    "privacy.informationCollected.securityChallenge": "Vi bruker rate limiting for å forhindre automatisert misbruk. rate limiting er designet for å beskytte personvernet og sporer ikke brukere på tvers av nettsteder.",
    ...
    "privacy.howWeUse.security": "Opprettholde sikkerhet: Oppdage og forhindre misbruk, som spam eller tjenestenektangrep, ved bruk av IP-logger og rate limiting.",
    ...
    "privacy.dataSecurity.securityMeasures": "Sikkerhetstiltak: Vi implementerer sterke sikkerhetsoverskrifter (f.eks. CSP, HSTS), inndatavalidering, beskyttelse mot timing-angrep og rate limiting for å forhindre misbruk.",
    ...
    "privacy.contact.email": "eller send e-post til.",
