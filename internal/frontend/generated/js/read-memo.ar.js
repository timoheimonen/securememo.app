...
MISSING_MEMO_ID: 'طلب غير صالح. يرجى التحقق من البيانات والمحاولة مرة أخرى.',
MISSING_PASSWORD: 'يرجى إدخال كلمة مرور التشفير',
INVALID_MEMO_URL: 'رابط المذكرة غير صالح',
MISSING_SECURITY_CHALLENGE: 'يرجى إكمال التحدي الأمني',
MEMO_ALREADY_READ_DELETED: 'تمت قراءة هذه المذكرة وحذفها بالفعل أو انتهت صلاحيتها.',
MEMO_EXPIRED_DELETED: 'انتهت صلاحية هذه المذكرة وتم حذفها.',
INVALID_PASSWORD_CHECK: 'كلمة المرور غير صحيحة. يرجى التحقق من كلمة المرور التي تلقيتها بشكل منفصل.',
READ_MEMO_ERROR: 'حدث خطأ أثناء قراءة المذكرة',
DECRYPTION_ERROR: 'فشل فك تشفير الرسالة. كلمة المرور غير صحيحة أو البيانات تالفة.'
};
...
decryptButton.textContent = 'جاري فك التشفير...';
}
...
showError('عدد كبير من الطلبات. يرجى الانتظار قليلاً ثم المحاولة مرة أخرى.');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'تم فك تشفير المذكرة. جارٍ الحذف... يرجى الانتظار.';
}
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'تم تأكيد قراءة المذكرة وحذفها نهائيًا.';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('حدث خطأ أثناء تأكيد الحذف. سيتم تنظيف المذكرة تلقائيًا.', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'فك تشفير المذكرة';
}
if (decryptLoadingIndicator) {
