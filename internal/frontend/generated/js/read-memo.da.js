...
MISSING_MEMO_ID: 'Ugyldig anmodning. Tjek venligst dine indtastninger og prøv igen.',
MISSING_PASSWORD: 'Indtast venligst krypteringsadgangskoden',
INVALID_MEMO_URL: 'Ugyldig notat-URL',
MISSING_SECURITY_CHALLENGE: 'Udfyld venligst sikkerhedsudfordringen',
MEMO_ALREADY_READ_DELETED: 'Dette notat er allerede blevet læst og slettet, eller det er udløbet.',
MEMO_EXPIRED_DELETED: 'Dette notat er udløbet og er blevet slettet.',
INVALID_PASSWORD_CHECK: 'Ugyldig adgangskode. Tjek venligst den adgangskode, du har modtaget separat.',
READ_MEMO_ERROR: 'Der opstod en fejl under læsning af notatet',
DECRYPTION_ERROR: 'Kunne ikke dekryptere beskeden. Ugyldig adgangskode eller beskadigede data.'
};
...
decryptButton.textContent = 'Dekrypterer...';
}
...
showError('For mange anmodninger. Vent venligst et øjeblik og prøv igen.');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'Notat dekrypteret. Sletning i gang... Vent venligst.';
}
if (deletionSpinner) {
...
showMessage('For mange anmodninger. Vent venligst et øjeblik og prøv igen.', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'Notat bekræftet som læst og permanent slettet.';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('Fejl ved bekræftelse af sletning. Notatet vil blive ryddet op automatisk.', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'Dekrypter Notat';
}
if (decryptLoadingIndicator) {
