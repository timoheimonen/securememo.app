...
MISSING_MEMO_ID: 'Permintaan tidak valid. Silakan periksa input Anda dan coba lagi.',
MISSING_PASSWORD: 'Silakan masukkan kata sandi enkripsi',
INVALID_MEMO_URL: 'URL memo tidak valid',
MISSING_SECURITY_CHALLENGE: 'Silakan selesaikan tantangan keamanan',
MEMO_ALREADY_READ_DELETED: 'Memo ini sudah dibaca dan dihapus, atau sudah kedaluwarsa.',
MEMO_EXPIRED_DELETED: 'Memo ini sudah kedaluwarsa dan telah dihapus.',
INVALID_PASSWORD_CHECK: 'Kata sandi tidak valid. Silakan periksa kata sandi yang Anda terima secara terpisah.',
READ_MEMO_ERROR: 'Terjadi kesalahan saat membaca memo',
DECRYPTION_ERROR: 'Gagal mendekripsi pesan. Kata sandi tidak valid atau data rusak.'
};
...
decryptButton.textContent = 'Mendekripsi...';
}
...
showError('Terlalu banyak permintaan. Silakan tunggu sejenak dan coba lagi.');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'Memo telah didekripsi. Sedang menghapus... Mohon tunggu.';
}
if (deletionSpinner) {
...
showMessage('Terlalu banyak permintaan. Silakan tunggu sejenak dan coba lagi.', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'Memo dikonfirmasi telah dibaca dan dihapus secara permanen.';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('Kesalahan dalam mengkonfirmasi penghapusan. Memo akan dibersihkan secara otomatis.', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'Dekripsi Memo';
}
if (decryptLoadingIndicator) {
