...
MISSING_MEMO_ID: 'Geçersiz istek. Lütfen girdinizi kontrol edin ve tekrar deneyin.',
MISSING_PASSWORD: 'Lütfen şifreleme parolasını girin',
INVALID_MEMO_URL: 'Geçersiz not URL’si',
MISSING_SECURITY_CHALLENGE: 'Lütfen güvenlik doğrulamasını tamamlayın',
MEMO_ALREADY_READ_DELETED: 'Bu not zaten okundu ve silindi veya süresi doldu.',
MEMO_EXPIRED_DELETED: 'Bu notun süresi doldu ve silindi.',
INVALID_PASSWORD_CHECK: 'Geçersiz parola. Lütfen size ayrı iletilen parolayı kontrol edin.',
READ_MEMO_ERROR: 'Not okunurken bir hata oluştu',
DECRYPTION_ERROR: 'Mesaj çözülemedi. Geçersiz parola veya bozulmuş veri.'
};
...
decryptButton.textContent = 'Çözülüyor...';
}
...
showError('Çok fazla istek yapıldı. Lütfen biraz bekleyip tekrar deneyin.');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'Not çözüldü. Siliniyor... Lütfen bekleyin.';
}
if (deletionSpinner) {
...
showMessage('Çok fazla istek yapıldı. Lütfen biraz bekleyip tekrar deneyin.', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'Not okundu ve kalıcı olarak silindi.';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('Silme onayında hata. Not otomatik olarak temizlenecek.', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'Notu Çöz';
}
if (decryptLoadingIndicator) {
