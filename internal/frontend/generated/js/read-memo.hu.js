...
MISSING_MEMO_ID: 'Érvénytelen kérés. Kérjük, ellenőrizze a bevitt adatokat és próbálja újra.',
MISSING_PASSWORD: 'Kérjük, adja meg a titkosítási jelszót',
INVALID_MEMO_URL: 'Érvénytelen jegyzet URL',
MISSING_SECURITY_CHALLENGE: 'Kérjük, teljesítse a biztonsági ellenőrzést',
MEMO_ALREADY_READ_DELETED: 'Ez a jegyzet már el lett olvasva és törölve, vagy lejárt.',
MEMO_EXPIRED_DELETED: 'Ez a jegyzet lejárt és törölve lett.',
INVALID_PASSWORD_CHECK: 'Érvénytelen jelszó. Kérjük, ellenőrizze a külön kapott jelszót.',
READ_MEMO_ERROR: 'Hiba történt a jegyzet olvasásakor',
DECRYPTION_ERROR: 'Nem sikerült visszafejteni az üzenetet. Érvénytelen jelszó vagy sérült adat.'
};
...
decryptButton.textContent = 'Visszafejtés folyamatban...';
}
...
showError('Túl sok kérés. Kérjük, várjon egy kicsit és próbálja újra.');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'Jegyzet visszafejtve. Törlés folyamatban... Kérjük, várj.';
}
if (deletionSpinner) {
...
showMessage('Túl sok kérés. Kérjük, várjon egy kicsit és próbálja újra.', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'A jegyzet olvasottnak jelölve és véglegesen törölve.';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('Hiba a törlés megerősítésekor. A jegyzet automatikusan törlődik.', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'Jegyzet visszafejtése';
}
if (decryptLoadingIndicator) {
