...
const TRANSLATIONS = {
  "cs": {
    ...
    "tos.acceptableUse.bypass": "Pokusit se obejít bezpečnostní opatření nebo ochranu rate limiting",
    ...
    "tos.intellectualProperty.copyright": "Autorská práva a politika DMCA: Pokud se domníváte, že došlo k porušení vašich autorských práv, kontaktujte nás na  s požadovanými informacemi dle DMCA (např. identifikace díla, vaše kontaktní údaje a prohlášení o dobré víře).",
    ...
    "tos.contact.email": "nebo napište na.",
    ...
    "privacy.informationCollected.securityChallenge": "Používáme rate limiting k zabránění automatizovanému zneužití. rate limiting je navržen s ohledem na soukromí a nesleduje uživatele napříč weby.",
    ...
    "privacy.howWeUse.security": "Udržování bezpečnosti: Detekci a prevenci zneužití, jako je spam nebo útoky typu denial‑of‑service, pomocí IP logů a rate limiting.",
    ...
    "privacy.dataSecurity.securityMeasures": "Bezpečnostní opatření: Zavádíme silné bezpečnostní hlavičky (např. CSP, HSTS), sanitizaci vstupů, ochranu proti časovým útokům a rate limiting pro zamezení zneužití.",
    ...
    "privacy.contact.email": "nebo napište na.",
