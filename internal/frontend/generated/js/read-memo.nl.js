...
MISSING_MEMO_ID: 'Ongeldige aanvraag. Controleer uw invoer en probeer het opnieuw.',
MISSING_PASSWORD: 'Voer het versleutelingswachtwoord in',
INVALID_MEMO_URL: 'Ongeldige memo-URL',
MISSING_SECURITY_CHALLENGE: 'Voltooi de beveiligingscontrole',
MEMO_ALREADY_READ_DELETED: 'Deze memo is al gelezen en verwijderd, of is verlopen.',
MEMO_EXPIRED_DELETED: 'Deze memo is verlopen en is verwijderd.',
INVALID_PASSWORD_CHECK: 'Ongeldig wachtwoord. Controleer het wachtwoord dat u apart heeft ontvangen.',
READ_MEMO_ERROR: 'Er is een fout opgetreden bij het lezen van de memo',
DECRYPTION_ERROR: 'Ontsleutelen van bericht mislukt. Ongeldig wachtwoord of corrupte data.'
};
...
decryptButton.textContent = 'Bezig met ontsleutelen...';
}
...
showError('Te veel verzoeken. Wacht even en probeer het opnieuw.');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'Memo ontsleuteld. Verwijderen bezig... Even geduld.';
}
if (deletionSpinner) {
...
showMessage('Te veel verzoeken. Wacht even en probeer het opnieuw.', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'Memo bevestigd als gelezen en permanent verwijderd.';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('Fout bij het bevestigen van verwijdering. De memo wordt automatisch opgeruimd.', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'Memo ontsleutelen';
}
if (decryptLoadingIndicator) {
