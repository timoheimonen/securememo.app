...
MISSING_MEMO_ID: 'Solicitud inválida. Por favor verifica tu entrada e intenta de nuevo.',
MISSING_PASSWORD: 'Por favor ingresa la contraseña de cifrado',
INVALID_MEMO_URL: 'URL de memo inválida',
MISSING_SECURITY_CHALLENGE: 'Por favor completa el desafío de seguridad',
MEMO_ALREADY_READ_DELETED: 'Este memo ya ha sido leído y eliminado, o ha expirado.',
MEMO_EXPIRED_DELETED: 'Este memo ha expirado y ha sido eliminado.',
INVALID_PASSWORD_CHECK: 'Contraseña inválida. Por favor verifica la contraseña que recibiste por separado.',
READ_MEMO_ERROR: 'Ocurrió un error al leer el memo',
DECRYPTION_ERROR: 'Falló al descifrar mensaje. Contraseña inválida o datos corruptos.'
};
...
decryptButton.textContent = 'Descifrando...';
}
...
showError('Demasiadas solicitudes. Por favor, espere un momento e inténtelo de nuevo.');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'Memo descifrado. Eliminación en progreso... Por favor espera.';
}
if (deletionSpinner) {
...
showMessage('Demasiadas solicitudes. Por favor, espere un momento e inténtelo de nuevo.', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'Memo confirmado como leído y eliminado permanentemente.';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('Error al confirmar la eliminación. El memo será limpiado automáticamente.', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'Descifrar Memo';
}
if (decryptLoadingIndicator) {
