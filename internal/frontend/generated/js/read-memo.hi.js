...
MISSING_MEMO_ID: 'अवैध अनुरोध। कृपया अपने इनपुट की जांच करें और फिर से कोशिश करें।',
MISSING_PASSWORD: 'कृपया एन्क्रिप्शन पासवर्ड दर्ज करें',
INVALID_MEMO_URL: 'अवैध मेमो URL',
MISSING_SECURITY_CHALLENGE: 'कृपया सुरक्षा चुनौती पूरी करें',
MEMO_ALREADY_READ_DELETED: 'यह मेमो पहले से पढ़ा जा चुका है और डिलीट हो चुका है, या यह समाप्त हो चुका है।',
MEMO_EXPIRED_DELETED: 'यह मेमो समाप्त हो चुका है और डिलीट कर दिया गया है।',
INVALID_PASSWORD_CHECK: 'गलत पासवर्ड। कृपया अलग से प्राप्त पासवर्ड की जांच करें।',
READ_MEMO_ERROR: 'मेमो पढ़ते समय एक त्रुटि आई',
DECRYPTION_ERROR: 'संदेश डिक्रिप्ट करने में विफल। गलत पासवर्ड या दूषित डेटा।'
};
...
decryptButton.textContent = 'डिक्रिप्ट कर रहे हैं...';
}
...
showError('बहुत सारे अनुरोध। कृपया एक क्षण प्रतीक्षा करें और फिर से कोशिश करें।');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'मेमो डिक्रिप्ट हो गया। डिलीट हो रहा है... कृपया प्रतीक्षा करें।';
}
if (deletionSpinner) {
...
showMessage('बहुत सारे अनुरोध। कृपया एक क्षण प्रतीक्षा करें और फिर से कोशिश करें।', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'मेमो पढ़ा गया और स्थायी रूप से डिलीट कर दिया गया।';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('डिलीशन की पुष्टि में त्रुटि। मेमो स्वचालित रूप से साफ हो जाएगा।', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'मेमो डिक्रिप्ट करें';
}
if (decryptLoadingIndicator) {
...
toggleBtn.textContent = 'छुपाएं';
toggleBtn.style.backgroundColor = '#007bff';
} else {
passwordInput.type = 'password';
toggleBtn.textContent = 'दिखाएं';
toggleBtn.style.backgroundColor = '#007bff';
}
});
}
