...
MISSING_MEMO_ID: 'Μη έγκυρη αίτηση. Παρακαλώ ελέγξτε τα δεδομένα εισόδου σας και δοκιμάστε ξανά.',
MISSING_PASSWORD: 'Παρακαλώ εισάγετε τον κωδικό κρυπτογράφησης',
INVALID_MEMO_URL: 'Μη έγκυρο URL σημείωσης',
MISSING_SECURITY_CHALLENGE: 'Παρακαλώ ολοκληρώστε την πρόκληση ασφαλείας',
MEMO_ALREADY_READ_DELETED: 'Αυτή η σημείωση έχει ήδη διαβαστεί και διαγραφεί, ή έχει λήξει.',
MEMO_EXPIRED_DELETED: 'Αυτή η σημείωση έχει λήξει και έχει διαγραφεί.',
INVALID_PASSWORD_CHECK: 'Μη έγκυρος κωδικός. Παρακαλώ ελέγξτε τον κωδικό που λάβατε ξεχωριστά.',
READ_MEMO_ERROR: 'Προέκυψε σφάλμα κατά την ανάγνωση της σημείωσης',
DECRYPTION_ERROR: 'Αποτυχία αποκρυπτογράφησης μηνύματος. Μη έγκυρος κωδικός ή κατεστραμμένα δεδομένα.'
};
...
decryptButton.textContent = 'Αποκρυπτογράφηση...';
}
...
showError('Πάρα πολλές αιτήσεις. Παρακαλώ περιμένετε λίγο και δοκιμάστε ξανά.');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'Η σημείωση αποκρυπτογραφήθηκε. Διαγραφή σε εξέλιξη... Παρακαλώ περιμένετε.';
}
if (deletionSpinner) {
...
showMessage('Πάρα πολλές αιτήσεις. Παρακαλώ περιμένετε λίγο και δοκιμάστε ξανά.', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'Η σημείωση επιβεβαιώθηκε ως αναγνωσμένη και διαγράφηκε οριστικά.';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('Σφάλμα κατά την επιβεβαίωση διαγραφής. Η σημείωση θα καθαριστεί αυτόματα.', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'Αποκρυπτογράφηση Σημείωσης';
}
if (decryptLoadingIndicator) {
...
toggleBtn.textContent = 'Εμφάνιση';
toggleBtn.style.backgroundColor = '#007bff';
}
});
}
