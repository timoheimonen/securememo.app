...
MISSING_MEMO_ID: 'Virheellinen pyyntö. Tarkista syötteesi ja yritä uudelleen.',
MISSING_PASSWORD: 'Syötä salaussalasana',
INVALID_MEMO_URL: 'Virheellinen muistion URL',
MISSING_SECURITY_CHALLENGE: 'Täytä turvallisuushaaste',
MEMO_ALREADY_READ_DELETED: 'Muistio on jo luettu ja poistettu, tai se on vanhentunut.',
MEMO_EXPIRED_DELETED: 'Muistio on vanhentunut ja poistettu.',
INVALID_PASSWORD_CHECK: 'Virheellinen salasana. Tarkista erikseen saamasi salasana.',
READ_MEMO_ERROR: 'Virhe muistion lukemisessa',
DECRYPTION_ERROR: 'Muistion purku epäonnistui. Virheellinen salasana tai vioittunut data.'
};
...
decryptButton.textContent = 'Purkamassa...';
}
...
showError('Liian monta pyyntöä. Odota hetki ja yritä uudelleen.');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'Muistio purettu. Poistetaan... Odota hetki.';
}
if (deletionSpinner) {
...
showMessage('Liian monta pyyntöä. Odota hetki ja yritä uudelleen.', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'Muistio vahvistettu luetuksi ja poistettu pysyvästi.';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('Virhe poistettaessa. Muistio poistetaan automaattisesti.', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'Pura Muistio';
}
if (decryptLoadingIndicator) {
