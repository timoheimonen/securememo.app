...
MISSING_MEMO_ID: 'Nieprawidłowe żądanie. Sprawdź dane i spróbuj ponownie.',
MISSING_PASSWORD: 'Proszę wprowadzić hasło szyfrujące',
INVALID_MEMO_URL: 'Nieprawidłowy adres URL notatki',
MISSING_SECURITY_CHALLENGE: 'Proszę ukończyć wyzwanie bezpieczeństwa',
MEMO_ALREADY_READ_DELETED: 'Ta notatka została już odczytana i usunięta lub wygasła.',
MEMO_EXPIRED_DELETED: 'Ta notatka wygasła i została usunięta.',
INVALID_PASSWORD_CHECK: 'Nieprawidłowe hasło. Sprawdź hasło otrzymane osobno.',
READ_MEMO_ERROR: 'Wystąpił błąd podczas odczytywania notatki',
DECRYPTION_ERROR: 'Nie udało się odszyfrować wiadomości. Nieprawidłowe hasło lub uszkodzone dane.'
};
...
decryptButton.textContent = 'Odszyfrowywanie...';
}
...
showError('Za dużo żądań. Proszę poczekać chwilę i spróbować ponownie.');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'Notatka odszyfrowana. Trwa usuwanie... Proszę czekać.';
}
if (deletionSpinner) {
...
showMessage('Za dużo żądań. Proszę poczekać chwilę i spróbować ponownie.', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'Notatka została odczytana i trwale usunięta.';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('Błąd potwierdzenia usunięcia. Notatka zostanie automatycznie wyczyszczona.', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'Odszyfruj notatkę';
}
if (decryptLoadingIndicator) {
