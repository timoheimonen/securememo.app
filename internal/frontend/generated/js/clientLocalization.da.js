...
const TRANSLATIONS = {
  "da": {
    ...
    "home.features.destruct.description": "Notatet slettes automatisk og permanent efter det er læst, eller når tidsgrænsen udløber (fra 8 timer til 30 dage).",
    ...
    "tos.acceptableUse.bypass": "Forsøge at omgå sikkerhedsforanstaltninger eller rate limiting-beskyttelse",
    ...
    "tos.intellectualProperty.copyright": "Ophavsret & DMCA-politik: Hvis du mener, at din ophavsret er blevet krænket, kontakt os venligst på  med de nødvendige oplysninger i henhold til DMCA (f.eks. identifikation af værket, dine kontaktoplysninger og en erklæring om god tro).",
    ...
    "privacy.informationCollected.memoData": "Notat-data: Når du opretter et notat, gemmer vi kun den krypterede version af din besked på vores servere (via Go service og SQLite database). Krypteringsnøglen (adgangskoden) genereres og håndteres udelukkende i din browser og sendes eller gemmes aldrig hos os. Notater slettes automatisk efter de er læst eller udløbet (muligheder: 8 timer, 1 dag, 2 dage, 1 uge eller 30 dage).",
    ...
    "privacy.informationCollected.securityChallenge": "Vi bruger rate limiting for at forhindre automatiseret misbrug. rate limiting er designet til at beskytte privatliv og sporer ikke brugere på tværs af sider.",
    ...
    "privacy.howWeUse.security": "At opretholde sikkerhed: Opdage og forhindre misbrug, såsom spam eller denial-of-service-angreb, ved hjælp af IP-logs og rate limiting.",
    ...
    "privacy.dataSecurity.deletion": "Sletning: Notater slettes permanent efter læsning eller udløb via automatiserede cleanup-jobs.",
    "privacy.dataSecurity.securityMeasures": "Sikkerhedsforanstaltninger: Vi implementerer stærke sikkerhedsheaders (f.eks. CSP, HSTS), input-sanitization, beskyttelse mod timing-angreb og rate limiting for at forhindre misbrug.",
