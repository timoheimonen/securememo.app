...
MISSING_MEMO_ID: 'คำขอไม่ถูกต้อง โปรดตรวจสอบข้อมูลที่กรอกและลองอีกครั้ง',
MISSING_PASSWORD: 'โปรดกรอกรหัสผ่านการเข้ารหัส',
INVALID_MEMO_URL: 'URL ของบันทึกไม่ถูกต้อง',
MISSING_SECURITY_CHALLENGE: 'โปรดทำแบบทดสอบความปลอดภัยให้เสร็จ',
MEMO_ALREADY_READ_DELETED: 'บันทึกนี้ถูกอ่านและลบไปแล้ว หรือหมดอายุแล้ว',
MEMO_EXPIRED_DELETED: 'บันทึกนี้หมดอายุและถูกลบแล้ว',
INVALID_PASSWORD_CHECK: 'รหัสผ่านไม่ถูกต้อง โปรดตรวจสอบรหัสผ่านที่คุณได้รับแยกต่างหาก',
READ_MEMO_ERROR: 'เกิดข้อผิดพลาดระหว่างการอ่านบันทึก',
DECRYPTION_ERROR: 'ถอดรหัสข้อความไม่สำเร็จ รหัสผ่านไม่ถูกต้องหรือข้อมูลเสียหาย'
};
...
decryptButton.textContent = 'กำลังถอดรหัส...';
}
...
showError('คำขอมากเกินไป โปรดรอสักครู่แล้วลองใหม่อีกครั้ง');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'ถอดรหัสบันทึกแล้ว กำลังลบ... โปรดรอ';
}
if (deletionSpinner) {
...
showMessage('คำขอมากเกินไป โปรดรอสักครู่แล้วลองใหม่อีกครั้ง', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'ยืนยันว่าบันทึกถูกอ่านแล้วและถูกลบถาวรแล้ว';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('เกิดข้อผิดพลาดในการยืนยันการลบ บันทึกจะถูกลบโดยอัตโนมัติ', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'ถอดรหัสบันทึก';
}
if (decryptLoadingIndicator) {
