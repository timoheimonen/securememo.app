...
const LOCAL_TRANSLATIONS = {
  "de": {
    ...
    "page.home.twitterDescription": "Privacy-First-App für sichere, verschlüsselte Memos mit automatischer Löschung.",
    "page.about.title": "Über securememo.app - Datenschutzorientierte verschlüsselte Notizen",
    "page.about.description": "Erfahren Sie mehr über den datenschutzorientierten Ansatz von securememo.app zum verschlüsselten Teilen von Memos. Gebaut mit browserseitiger AES-256-Verschlüsselung, automatischer Löschung und ohne Benutzerkonten.",
    ...
    "page.about.ogDescription": "Entdecken Sie, wie securememo.app Memoinhalte durch browserseitige Verschlüsselung und automatische Löschung nach erfolgreicher Lesebestätigung oder Ablauf schützt.",
    ...
    "home.current.hero.title": "Geheimnisse teilen, die verschwinden.",
    "home.current.hero.subtitle": "Erstellen Sie ein verschlüsseltes Memo in Ihrem Browser. Es löscht sich nach dem Lesen oder nach Ablauf automatisch.",
    ...
    "home.current.delete.title": "Es löscht sich automatisch",
    ...
    "home.current.delete.description": "Das Memo wird nach dem Lesen entfernt oder automatisch, wenn die Ablaufzeit erreicht ist.",
    "schema.app.features.browserSideEncryption": "Verschlüsselung im Browser",
    "schema.app.features.selfDeletingMemos": "Selbstlöschende Memos",
    "home.current.schema.description": "Erstellen Sie ein verschlüsseltes Memo in Ihrem Browser. Es löscht sich nach dem Lesen oder nach Ablauf automatisch. Kein Tracking, keine Werbung.",
    "about.current.hero.subtitle": "Mit securememo.app können Sie kurze, private Notizen senden, die nach dem Lesen verschwinden. Alles wird in Ihrem Browser verschlüsselt, sodass der Server nie sieht, was Sie geschrieben haben.",
    ...
    "about.current.delete.title": "Memos löschen sich selbst",
    ...
    "about.current.delete.description": "Ein Memo wird nach dem Lesen entfernt oder wenn seine Ablaufzeit erreicht ist. Sie können zwischen 8 Stunden und 30 Tagen wählen.",
    ...
    "about.current.ogDescription": "Entdecken Sie, wie securememo.app Memoinhalte mit Verschlüsselung im Browser und automatischer Löschung nach dem Lesen oder Ablauf schützt.",
