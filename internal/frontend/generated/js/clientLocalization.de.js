...
const LOCAL_TRANSLATIONS = {
  "de": {
    ...
    "btn.copyRevokeLink": "Widerrufslink kopieren",
    "btn.deleteMemo": "Memo löschen",
    ...
    "page.revoke.title": "Sicheres Memo widerrufen - ungelesenes Memo löschen",
    "page.revoke.description": "Verwenden Sie einen privaten Widerrufslink, um ein verschlüsseltes sicheres Memo vor dem Lesen zu löschen.",
    "page.revoke.keywords": "sicheres Memo widerrufen, verschlüsseltes Memo löschen, sichere Notiz löschen, privater Memo-Widerrufslink",
    "page.revoke.ogDescription": "Löschen Sie ein verschlüsseltes sicheres Memo vor dem Lesen mit Ihrem privaten Widerrufslink.",
    "page.revoke.twitterDescription": "Löschen Sie ein verschlüsseltes sicheres Memo vor dem Lesen.",
    ...
    "create.result.revokeLabel": "Widerrufslink (privat halten):",
    "create.result.revokeHelp": "Verwenden Sie diesen privaten Link, um das Memo vor dem Lesen zu löschen. Er wird nur einmal angezeigt und kann nach dem Verlassen dieser Seite nicht wiederhergestellt werden.",
    "create.result.revokeWarning": "Halten Sie den Widerrufslink privat; jeder mit diesem Link kann dieses Memo vor dem Lesen löschen",
    ...
    "revoke.hero.title": "Sicheres Memo widerrufen",
    "revoke.hero.description": "Dieser private Widerrufslink kann das Memo vor dem Lesen löschen. Die Löschung ist dauerhaft und kann nicht rückgängig gemacht werden.",
    "revoke.confirm.title": "Dieses Memo löschen?",
    "revoke.confirm.before": "Bevor Sie fortfahren:",
    "revoke.confirm.exists": "Dies löscht das Memo sofort, wenn es noch nicht gelesen, abgelaufen oder gelöscht wurde",
    "revoke.confirm.permanent": "Die Löschung ist dauerhaft und das Memo kann nicht wiederhergestellt werden",
    "revoke.confirm.recipient": "Der Empfänger kann das Memo nicht mehr lesen",
    "revoke.confirm.sends": "Diese Anfrage sendet nur die Memo-ID und das Widerrufstoken an den Server. Sie sendet weder das Memo-Passwort noch den Klartextinhalt des Memos.",
    "revoke.status.deleting": "Memo wird gelöscht...",
    "revoke.success.title": "Memo gelöscht",
    "revoke.success.description": "Das Memo wurde erfolgreich widerrufen. Der Empfänger kann es nicht mehr lesen.",
    "revoke.error.title": "Ungültiger Widerrufslink",
    "msg.passwordCopied.plain": "Passwort in die Zwischenablage kopiert!",
    "msg.revokeLinkCopied": "Widerrufslink in die Zwischenablage kopiert!",
    ...
    "error.invalidRevokeLink": "Dieser Widerrufslink ist ungültig oder unvollständig.",
    "error.revokeNotFound": "Memo nicht gefunden, bereits gelöscht, abgelaufen oder der Widerrufslink ist ungültig.",
    "error.revokeFailed": "Das Memo konnte nicht widerrufen werden. Bitte überprüfen Sie Ihre Verbindung und versuchen Sie es erneut.",
    ...
    "about.current.storage.stored.revokeHash": "Hash des Absender-Widerrufstokens",
    ...
    "about.current.storage.notStored.rawTokens": "Rohe Lösch- oder Widerrufstokens",
