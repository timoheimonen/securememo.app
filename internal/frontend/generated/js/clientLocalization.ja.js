...
const TRANSLATIONS = {
  "ja": {
    ...
    "about.usage.create.description": "\"Create Secure Memo\" に移動してメモを入力します。有効期限（8時間、1日、2日、1週間、または最大30日）を選択します。メモは読み取り確認が成功した後、または期限切れ後に削除されます。ブラウザがランダムな暗号化パスワードを生成します。",
