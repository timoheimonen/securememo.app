...
MISSING_MEMO_ID: 'Ugyldig forespørsel. Vennligst sjekk innholdet og prøv igjen.',
MISSING_PASSWORD: 'Vennligst skriv inn krypteringspassordet',
INVALID_MEMO_URL: 'Ugyldig notat-URL',
MISSING_SECURITY_CHALLENGE: 'Vennligst fullfør sikkerhetsutfordringen',
MEMO_ALREADY_READ_DELETED: 'Dette notatet er allerede lest og slettet, eller det har utløpt.',
MEMO_EXPIRED_DELETED: 'Dette notatet har utløpt og er slettet.',
INVALID_PASSWORD_CHECK: 'Ugyldig passord. Vennligst sjekk passordet du mottok separat.',
READ_MEMO_ERROR: 'En feil oppstod under lesing av notatet',
DECRYPTION_ERROR: 'Kunne ikke dekryptere meldingen. Ugyldig passord eller ødelagte data.'
};
...
showError('For mange forespørsler. Vennligst vent litt og prøv igjen.');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'Notatet er dekryptert. Sletter... Vennligst vent.';
}
if (deletionSpinner) {
...
showMessage('For mange forespørsler. Vennligst vent litt og prøv igjen.', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'Notatet er bekreftet lest og permanent slettet.';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('Feil ved bekreftelse av sletting. Notatet vil bli ryddet opp automatisk.', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'Dekrypter notatet';
}
if (decryptLoadingIndicator) {
