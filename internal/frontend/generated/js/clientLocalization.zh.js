...
const TRANSLATIONS = {
  "zh": {
    ...
    "about.usage.destruct.description": "当收件人打开链接并单独输入密码时，备忘录将被解密，然后在阅读后永久删除，或在过期后自动删除。过期的备忘录每小时自动清理一次。",
    ...
    "privacy.internationalTransfers.content": "securememo.app 在芬兰自托管。数据在芬兰处理，我们将数据收集保持在最低限度。",
    ...
    "faq.duration.answer": "备忘录可以设置为在 8 小时、1 天、2 天、1 周或最多 30 天后过期。它们也会在阅读后立即删除。过期的备忘录每小时自动清理。",
    ...
    "faq.technology.answer": "securememo.app 基于 Go service 的无服务器计算、SQLite 数据库的存储、Web Crypto API 的客户端加密和现代 HTML/CSS/JavaScript 构建。源代码开源并在 GitHub 上可用。",
