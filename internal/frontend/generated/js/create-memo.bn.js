...
if (!message) {
showMessage('অনুগ্রহ করে একটি মেমো লিখুন', 'error');
return;
}
if (message.length > 10000) {
showMessage('মেমোটি খুব বড় (সর্বোচ্চ ১০,০০০ অক্ষর)', 'error');
return;
}
...
if (err) {
showMessage('অনুগ্রহ করে নিরাপত্তা চ্যালেঞ্জ সম্পূর্ণ করুন', 'error');
...
submitButton.textContent = 'এনক্রিপ্ট করা হচ্ছে...';
...
showMessage(result.error || 'মেমো তৈরি ব্যর্থ হয়েছে', 'error');
}
}
} catch (error) {
showMessage('মেমো তৈরি করার সময় একটি ত্রুটি ঘটেছে', 'error');
} finally {
submitButton.disabled = false;
submitButton.textContent = 'নিরাপদ মেমো তৈরি করুন';
...
showMessage('✅ URL ক্লিপবোর্ডে কপি হয়েছে!', 'success');
...
showMessage('⚠️ অনুগ্রহ করে ম্যানুয়ালি কপি করুন (Ctrl+C / Cmd+C)', 'warning');
}
});
...
showMessage('✅ পাসওয়ার্ড ক্লিপবোর্ডে কপি হয়েছে!', 'success');
