...
MISSING_MEMO_ID: 'Ogiltig begäran. Kontrollera din inmatning och försök igen.',
MISSING_PASSWORD: 'Vänligen ange krypteringslösenordet',
INVALID_MEMO_URL: 'Ogiltig memo-URL',
MISSING_SECURITY_CHALLENGE: 'Vänligen slutför säkerhetsutmaningen',
MEMO_ALREADY_READ_DELETED: 'Denna memo har redan lästs och raderats, eller har gått ut.',
MEMO_EXPIRED_DELETED: 'Denna memo har gått ut och har raderats.',
INVALID_PASSWORD_CHECK: 'Ogiltigt lösenord. Kontrollera lösenordet du fick separat.',
READ_MEMO_ERROR: 'Ett fel uppstod vid läsning av memo',
DECRYPTION_ERROR: 'Det gick inte att dekryptera meddelandet. Ogiltigt lösenord eller korrupt data.'
};
...
decryptButton.textContent = 'Dekrypterar...';
}
...
showError('För många förfrågningar. Vänta en stund och försök igen.');
return;
}
...
if (memoStatus) {
memoStatus.textContent = 'Memo dekrypterad. Radering pågår... Vänta.';
}
if (deletionSpinner) {
...
showMessage('För många förfrågningar. Vänta en stund och försök igen.', 'error');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
...
const deletionSpinner = document.getElementById('deletionSpinner');
if (memoStatus) {
memoStatus.textContent = 'Memo bekräftad som läst och permanent raderad.';
}
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
} else {
showMessage('Fel vid bekräftelse av radering. Memo kommer att raderas automatiskt.', 'warning');
const deletionSpinner = document.getElementById('deletionSpinner');
if (deletionSpinner) {
deletionSpinner.style.display = 'none';
}
...
decryptButton.textContent = 'Dekryptera memo';
}
if (decryptLoadingIndicator) {
