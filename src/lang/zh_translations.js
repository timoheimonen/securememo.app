export const zh = {
  ...
  "page.home.description":
    "创建阅读后自毁的加密备忘录。端到端加密、隐私优先和使用AES-256的安全笔记分享。无跟踪，无广告。",
  ...
  "page.about.description":
    "了解 securememo.app 隐私优先的加密消息方法。基于客户端 AES-256 加密、自毁消息和零知识架构构建。",
  ...
  "page.create.title": "创建安全备忘录 - 加密的自毁备忘录",
  "page.create.keywords": "创建安全备忘录, 加密备忘录, 自毁笔记, AES-256 加密, 私密备忘录分享, 安全笔记创建",
  "page.read.title": "阅读安全备忘录 - 解密加密的备忘录",
  "page.read.keywords": "阅读安全备忘录, 解密备忘录, 加密笔记阅读, AES-256 解密, 私密备忘录访问",
  "page.tos.title": "服务条款 - securememo.app 法律条款",
  "page.tos.description": "securememo.app 的服务条款——加密备忘录分享服务。了解可接受使用、隐私、安全和法律条款。",
  "page.tos.keywords": "服务条款, 安全备忘录法律, 加密备忘录条款, 隐私政策, 可接受使用政策, 安全笔记分享条款",
  "page.tos.ogTitle": "服务条款 - securememo.app 法律条款",
  "page.tos.ogDescription": "securememo.app 加密备忘录分享服务的法律条款与条件。",
  "page.tos.twitterDescription": "securememo.app 加密备忘录分享服务的法律条款。",
  "page.privacy.title": "隐私声明 - securememo.app 数据保护",
  "page.privacy.description":
    "securememo.app 的隐私声明——了解我们如何通过客户端加密、零知识架构和最少数据收集来保护您的数据。",
  "page.privacy.keywords": "隐私声明, 安全备忘录隐私, 数据保护, GDPR 合规, 客户端加密, 零知识, 安全备忘录分享隐私",
  "page.privacy.ogTitle": "隐私声明 - securememo.app 数据保护",
  ...
  "home.features.encrypt.description":
    "输入您的备忘录。在发送到我们的服务器之前，它会在您的浏览器中使用强大的 AES-256 加密进行加密。",
  "home.features.share.title": "🔗 安全分享",
  "home.features.share.description":
    "获取一个唯一链接和一个单独的随机密码，并通过不同的渠道分享它们以获得额外的安全性。",
  "home.features.destruct.title": "💥 自动销毁",
  "home.features.destruct.description": "备忘录在阅读后或时间限制到期后将被永久删除（从 8 小时到 30 天）。",

  "home.security.title": "安全功能",
  "home.security.encryption.title": "🔒 真正的客户端加密",
  "home.security.encryption.description":
    "您的备忘录在浏览器中通过 AES-256-GCM 和强健的密钥派生进行加密。我们从不会看到明文。",
  ...
  "home.security.password.description":
    "我们完全在您的浏览器中生成和处理密码。它们从不会被发送到我们的服务器或存储在我们的服务器上。",
  ...
  "about.hero.subtitle":
    "securememo.app 是一个以隐私为重点的应用程序，允许您创建在阅读或过期后自毁的加密备忘录。以安全和隐私为首要优先级构建。源代码在 GitHub 上可用。",
  ...
  "about.features.clientEncryption.description":
    "所有加密都在您的浏览器中使用 Web Crypto API 进行。您的备忘录在发送到我们的服务器之前会使用 AES-256 进行加密。",
  ...
  "about.features.selfDestruct.description":
    "一旦备忘录被阅读或过期，它会立即从我们的数据库中永久删除。不会留下任何痕迹。",
  ...
  "about.features.privacy.description": "无需用户账户。无跟踪。无分析工具。您的隐私是我们的首要考虑。",

  "about.usage.title": "如何使用",
  "about.usage.create.title": "1. 创建备忘录",
  "about.usage.create.description":
    "转到“创建安全备忘录”并输入您的备忘录。选择过期时间（8小时、1天、2天、1周或最多30天）。备忘录在阅读或过期时会被删除。系统将生成一个随机加密密码。",
  ...
  "about.usage.destruct.description":
    "当收件人打开链接并单独输入密码时，备忘录将被解密，然后在阅读后永久删除，或在过期后自动删除。过期的备忘录每小时自动清理一次。",
  ...
  "tos.serviceDescription.content":
    "securememo.app 是一个安全备忘录分享服务，允许用户创建在阅读或过期后自毁的加密备忘录。该服务使用客户端加密来确保我们的服务器永远无法访问备忘录内容。",
  ...
  "tos.privacyData.noPersonal":
    "最小化数据收集：我们不要求用户账户，也不收集您使用本服务所需的个人信息。我们唯一可能收集的个人数据是在您主动联系我们寻求支持时。如果您通过电子邮件联系我们，我们会收集您的邮箱地址和消息内容以便回复。我们不会将这些信息用于其他目的，亦不会在未经您同意的情况下与第三方分享。",
  "tos.privacyData.securityLogging":
    "安全日志记录：我们临时记录 IP 地址和安全相关元数据，严格用于滥用缓解和保护服务完整性。这些日志从不用于跟踪或分析。",
  "tos.privacyData.automaticDeletion": "自动删除：备忘录在阅读或过期后会自动删除。",
  "tos.privacyData.noRecovery": "无法恢复：一旦备忘录被删除，就无法恢复。",
  "tos.privacyData.gdpr":
    "GDPR 合规：我们遵循 GDPR 原则。我们将数据收集降至最低，并基于合法利益仅处理为保护服务所必需的数据（例如临时安全日志）。",
  ...
  "tos.securityDisclaimers.userResponsibility":
    "用户责任：您有责任安全地分享备忘录 URL 和保护密码。如果密码丢失，备忘录无法恢复。",
  "tos.securityDisclaimers.noWarranty":
    '无保证：服务不提供任何形式的保证。我们的加密服务按"现状"和"可用状态"提供。我们不保证加密不会中断、无错误或免受所有潜在威胁。',
  "tos.securityDisclaimers.limitation":
    "责任限制：我们不对使用服务产生的任何损害承担责任。您承认没有电子传输或存储方法是 100% 安全的，我们不对您备忘录的任何未经授权访问或拦截负责。使用我们的加密服务风险自负。",
  "tos.securityDisclaimers.securityMeasures": "安全措施：虽然我们实施安全措施，但没有系统是 100% 安全的。",
  "tos.securityDisclaimers.exportControls":
    "出口管制：您同意不违反任何出口管制法律使用服务，包括那些限制在受制裁国家使用的法律。",

  "tos.intellectualProperty.title": "6. 知识产权",
  "tos.intellectualProperty.content":
    "服务及通过其提供的所有材料，包括但不限于文本、图形、徽标和软件，均为 securememo.app 或其许可方的财产，受版权、商标和其他知识产权法保护。您同意不修改、复制、分发或基于我们的内容创建衍生作品，除非获得明确许可，用于服务内的个人、非商业用途除外。",
  "tos.intellectualProperty.copyright":
    "版权和 DMCA 政策：如果您认为您的版权受到侵犯，请使用 DMCA 规定的必要信息联系我们 contact@securememo.app（例如，作品识别、您的联系方式和善意声明）。",

  "tos.indemnification.title": "7. 赔偿",
  "tos.indemnification.content":
    "您同意为 securememo.app 及其关联公司、高级职员、董事、员工和代理人进行辩护、赔偿并使其免受因您访问或使用我们的服务（包括您违反这些条款）而产生或以任何方式相关的任何索赔、责任、损害、损失和费用（包括合理的律师费）的损害。",
  ...
  "tos.governingLaw.content":
    "本服务条款以及我们为您提供服务的任何单独协议均应受芬兰法律管辖并根据芬兰法律解释，不考虑其法律冲突原则。任何争议应在芬兰赫尔辛基的法院解决。",

  "tos.miscellaneous.title": "11. 杂项",
  "tos.miscellaneous.severability":
    "可分割性：如果这些条款的任何条款被有管辖权的法院认定为无效或不可执行，该条款将从条款中分离，其余条款将继续完全有效。",
  "tos.miscellaneous.assignment":
    "转让：未经我们事先书面同意，您不得通过法律行为或其他方式转让或移交这些条款。我们可以自行决定转让这些条款，无需通知您。",
  "tos.miscellaneous.waiver": "放弃：除非书面形式，任何条款的放弃不应被视为进一步或持续的放弃。",
  "tos.miscellaneous.children":
    "儿童隐私：我们的服务不适用于 13 岁以下（在某些司法管辖区为 16 岁以下）的儿童。我们不会故意收集儿童数据。如果我们发现此类数据，我们将立即删除。",
  ...
  "tos.languageDisclaimer.content":
    "为了您的方便，这些服务条款可能会被翻译成其他语言。如果英文版本和翻译版本之间存在任何差异或冲突，以英文版本为准。",
  ...
  "privacy.tableOfContents.changesNotice": "隐私声明的变更",
  "privacy.tableOfContents.contact": "联系我们",

  "privacy.intro.p1":
    'securememo.app（"我们"、"我们的"或"我方"）致力于保护您的隐私。本隐私声明解释了我们如何处理与我们的服务相关的信息，该服务允许用户创建和分享在阅读或过期后自毁的加密备忘录。我们的服务以隐私为核心设计：所有加密都在您的浏览器中客户端进行，我们无法访问您的备忘录内容。',
  ...
  "privacy.informationCollected.memoData":
    "备忘录数据：当您创建备忘录时，我们仅在服务器上存储您消息的加密版本（使用 Cloudflare Workers 和 D1 数据库）。加密密钥（密码）完全在您的浏览器中生成和处理，从不发送到我们的服务器或由我们存储。备忘录在阅读或过期后会自动删除（选项：8 小时、1 天、2 天、1 周或 30 天）。",
  "privacy.informationCollected.noPersonal":
    "最小化数据收集：我们不要求用户账户，也不收集您使用本服务所需的个人信息。我们唯一可能获得的个人数据是在您主动联系支持时。如果您通过电子邮件联系我们，我们会收集您的邮箱地址和消息内容以回复您的询问。我们不会将这些信息用于其他目的，亦不会在未经您同意的情况下与第三方分享。",
  "privacy.informationCollected.securityData": "与安全相关的数据：为了防止滥用和服务完整性：",
  "privacy.informationCollected.ipLogs":
    "我们临时记录 IP 地址和请求元数据（例如时间戳）以检测和缓解垃圾邮件、机器人或恶意活动。",
  "privacy.informationCollected.turnstile":
    "我们使用 Cloudflare Turnstile 验证码来防止自动化滥用。Turnstile 旨在保护隐私，不会跨站点跟踪用户。",
  "privacy.informationCollected.noAnalytics":
    "无分析或跟踪：我们不使用 cookie、跟踪像素、第三方分析或广告工具。没有用户分析、行为跟踪或营销目的数据收集。",
  "privacy.informationCollected.noSensitive":
    "我们不收集敏感个人数据、位置信息或设备标识符，超出基本服务运营所必需的范围。",
  ...
  "privacy.yourRights.contact":
    "如果您认为我们持有关于您的任何信息（例如来自日志），请联系我们（见下文）咨询您在 GDPR 或 CCPA 等适用法律下的权利。我们遵守数据保护法规，并在可行的情况下处理请求。",

  "privacy.childrenPrivacy.title": "7. 儿童隐私",
  "privacy.childrenPrivacy.content":
    "我们的服务不适用于 13 岁以下（在某些司法管辖区为 16 岁以下）的儿童。我们不会故意收集儿童数据。如果我们发现此类数据，我们将删除它。",

  "privacy.internationalTransfers.title": "8. 国际数据传输",
  "privacy.internationalTransfers.content":
    "securememo.app 托管在 Cloudflare 的全球网络上。数据可能在各个国家处理，但我们通过最少收集做法确保同等的隐私保护。",

  "privacy.changesNotice.title": "9. 隐私声明的变更",
  "privacy.changesNotice.content":
    '我们可能定期更新本声明。更改将在此处发布，并更新"最后更新"日期。更改后继续使用服务即表示接受。',
  ...
  "schema.app.description":
    "创建阅读后自毁的加密备忘录。端到端加密、隐私优先和使用 AES-256 的安全笔记分享。无跟踪，无广告。",
  ...
  "faq.privacy.answer":
    "securememo.app 使用客户端 AES-256 加密，意味着您的备忘录在发送到我们的服务器之前就在您的浏览器中加密。我们从不会看到明文内容。备忘录在阅读或过期后自毁，我们不需要用户账户或收集个人信息。",
  "faq.encryption.question": "securememo.app 使用什么加密？",
  "faq.encryption.answer":
    "我们使用 AES-256-GCM 加密与 PBKDF2 密钥派生。所有加密都在您的浏览器中通过 Web Crypto API 在客户端完成。加密密码单独生成，且从不存储在我们的服务器上。",
  "faq.duration.question": "备忘录能持续多久？",
  "faq.duration.answer":
    "备忘录可以设置为在 8 小时、1 天、2 天、1 周或最多 30 天后过期。它们也会在阅读后立即删除。过期的备忘录每小时自动清理。",
  "faq.recovery.question": "我可以恢复已删除的备忘录吗？",
  "faq.recovery.answer":
    "不可以，一旦备忘录被删除（无论是阅读后还是过期时），它都不能被恢复。这是为了最大的隐私和安全性而设计的。",
  ...
  "faq.technology.answer":
    "securememo.app 基于 Cloudflare Workers 的无服务器计算、D1 数据库的存储、Web Crypto API 的客户端加密和现代 HTML/CSS/JavaScript 构建。源代码开源并在 GitHub 上可用。",
  ...
  "create.schema.description": "创建阅读后自毁的加密备忘录。客户端 AES-256 加密确保您的秘密保持私密。",
  ...
  "read.schema.description":
    "使用密码解密和阅读您的安全备忘录。备忘录在阅读后自毁，以获得最大隐私。客户端 AES-256 解密。",
  ...
  "form.memoPassword.help":
    "这是加密密码。为了增强安全性，请将其与 URL 分开分享。这不会保存在我们的服务器上，离开此页面后无法恢复。",
  ...
  "schema.privacy.description":
    "securememo.app 隐私声明 - 了解我们如何通过客户端加密、零知识架构和最少数据收集来保护您的数据。",
