...
export function buildContentSecurityPolicy(nonce) {
  const directives = [
    ...
    'frame-src https://challenges.cloudflare.com https://www.youtube-nocookie.com blob:',
    'child-src https://challenges.cloudflare.com https://www.youtube-nocookie.com blob:',
