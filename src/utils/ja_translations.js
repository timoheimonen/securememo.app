export const ja = {
    ...
    'home.features.share.description': '一意のURLと別々のランダムパスワードを取得し、セキュリティを強化するために異なるチャネルで共有します。',
    ...
    'tos.intellectualProperty.copyright': '著作権・DMCA方針: あなたの著作権が侵害されたと思われる場合は、DMCA に基づく必要な情報（作品の識別、連絡先詳細、誠実な信念の陳述など）を添えて contact@securememo.app までご連絡ください。',
